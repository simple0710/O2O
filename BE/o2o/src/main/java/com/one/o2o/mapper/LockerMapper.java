...
public interface LockerMapper {
    ...
    @Mapping(source="products.productNm", target="productNm")
    @Mapping(source = "products.productImgs", target = "productImgs", qualifiedByName = "productImgsToDto")
    @Mapping(source = "products.productImg", target = "productImg")
