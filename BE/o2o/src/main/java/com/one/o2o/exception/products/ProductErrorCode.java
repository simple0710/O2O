...
public enum ProductErrorCode implements ErrorCode {
    // 제품 ID
    PRODUCT_ID_NOT_FOUND(HttpStatus.NOT_FOUND, "제품을 찾을 수 없습니다."),

    // 제품 이름
    PRODUCT_NAME_MISSING(HttpStatus.BAD_REQUEST, "제품 이름이 올바르지 않습니다."),
    ...
    PRODUCT_CNT_INVALID(HttpStatus.BAD_REQUEST, "유효하지 않은 제품 개수 값입니다."),
