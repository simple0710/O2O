...
//     const itemsToDelete = Object.keys(checkedItems).filter(key => checkedItems[key]);

//     for (let itemId of itemsToDelete) {
//       const [index, productIndex] = itemId.split('-');
//       const reserve = reservations.reserves[index];

//       try {
//         await deleteReservation(reserve.reserve_id); // Send DELETE request
//         setReservations(prevState => ({
//           ...prevState,
//           reserves: prevState.reserves.filter((_, idx) => idx !== parseInt(index))
//         }));
//       } catch (error) {
